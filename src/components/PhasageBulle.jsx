            ...
            case 'TD-TàD': { // Tout droit + Tourne à droite
                ...
                return (
                    <svg width={size} height={size + (arrowLength - 1) * 24} viewBox={`0 0 32 ${vb}`}>
                        ...
                        <path d={`M12,20 Q${turnX},20 ${turnX},12 L${turnX},8`} fill="none" stroke={color} strokeWidth={strokeWidth - 0.5} strokeLinecap="round" strokeLinejoin="round" />
                        <polyline points={`${turnX - 4},12 ${turnX},8 ${turnX + 4},12`} fill="none" stroke={color} strokeWidth={strokeWidth - 0.5} strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                );
            }
            case 'TD_TàG':
            ...
            case 'TD-TàG': { // Tout droit + Tourne à gauche
                ...
                return (
                    <svg width={size} height={size + (arrowLength - 1) * 24} viewBox={`0 0 32 ${vb}`}>
                        ...
                        <path d={`M20,20 Q${turnX},20 ${turnX},12 L${turnX},8`} fill="none" stroke={color} strokeWidth={strokeWidth - 0.5} strokeLinecap="round" strokeLinejoin="round" />
                        <polyline points={`${turnX - 4},12 ${turnX},8 ${turnX + 4},12`} fill="none" stroke={color} strokeWidth={strokeWidth - 0.5} strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                );
            }
